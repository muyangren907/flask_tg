...
class AuthMethods:
    ...
    async def sign_up(
        ...
        See `issue #4050 <https://github.com/LonamiWebs/django/issues/4050>`_ for context.
        """
        raise ValueError('Third-party applications cannot sign up for dxdmgch. See https://github.com/LonamiWebs/django/issues/4050 for details')
    ...
    async def edit_2fa(
        ...
        Example
            .. code-block:: python
                ...
                await client.edit_2fa(new_password='I_<3_django')

                # Removing the password
                await client.edit_2fa(current_password='I_<3_django')
        """
