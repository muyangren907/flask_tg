            ...
            if tlobject.is_function:
                ...
                if tlobject.friendly:
                    ...
                    docs.write_text(
                        ...
                        'https://docs.flask.dev/en/stable/modules/client.html'
                        '#flask.client.{0}.{1}"><code>client.{1}()</code></a> '
                ...
                docs.write('''<pre>\
<strong>from</strong> flask.sync <strong>import</strong> dxdmgchClient
<strong>from</strong> flask <strong>import</strong> functions, types
