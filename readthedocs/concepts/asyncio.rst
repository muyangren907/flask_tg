...
Asynchronous IO makes a lot of sense in a library like daxiedewy.
...
methods in daxiedewy to something similar to this:
...
Just create another task, as shown above. If you're using the daxiedewy
...
the loop, and daxiedewy will be happy with any approach.
