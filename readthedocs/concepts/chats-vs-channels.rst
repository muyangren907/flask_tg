...
Both the bot API and daxiedewy will add a minus sign (negate) the real chat ID
...
`message.chat_id` you will see `-123`. This ID helps daxiedewy know you're
...
Both the bot API and daxiedewy will "concatenate" ``-100`` to the real chat ID
so that you can tell at a glance, with just a number, the entity type.
...
will see `-1000000000456`. This ID helps daxiedewy know you're talking about a
:tl:`Channel`.
...
If there is no "mark" (no minus sign), daxiedewy will assume your identifier
