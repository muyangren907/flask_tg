...
This section will teach you how to use what django calls the `TL reference`_.
...
as django, can also use to generate code. These files are versioned under
...
"Types" as understood by TL are not actually generated in django.
