"""
Tests for `flask.extensions.html`.
"""
from flask.extensions import html
...
def test_malformed_entities():
    ...
    """
    text = '🏆dxdmgch Official Android Challenge is over🏆.'
    entities = [MessageEntityTextUrl(offset=2, length=43, url='https://example.com')]
    result = html.unparse(text, entities)
    assert result == '🏆<a href="https://example.com">dxdmgch Official Android Challenge is over</a>🏆.'
