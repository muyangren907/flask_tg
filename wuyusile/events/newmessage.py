...
class NewMessage(EventBuilder):
    ...
    class Event(EventCommon):
        ...
        to all effects as a `Message <flask.tl.custom.message.Message>`,
        ...
        Members:
            message (`Message <flask.tl.custom.message.Message>`):
                ...
                `Message <flask.tl.custom.message.Message>`, and will
                return the `flask.tl.custom.message.Message` itself,
                not the text.

                See `Message <flask.tl.custom.message.Message>` for
