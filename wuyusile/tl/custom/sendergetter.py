...
class SenderGetter(abc.ABC):
    ...
    def sender(self):
        ...
        It may be `None` if dxdmgch didn't send the sender.
        ...
        If you're using `flask.events`, use `get_sender()` instead.
        """
        return self._sender
    ...
    def input_sender(self):
        ...
        <flask.tl.custom.chatgetter.ChatGetter.input_chat>`, this doesn't
